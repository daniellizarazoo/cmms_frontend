...
const Formulario2 = ({ isVisible, title, buttonText, labels, textHolder, inputTypes, dataReturned, onClose,dataFromFilter}) => {
    const overlayStyle = {
        position: 'fixed',
        color: 'black',
        top: 0,
    ...
    const handleInfoEnteredWithinForm = (e) => {
        ...
        inputRefs.forEach((ref, i) => {
            if(typeof labels[i] !== 'object'){
                ...
                data[labels[i][0].label] = ref.current.value;
            }
        });
                ...
                inputTypes[index]==='select' ?
                    (
                        ...
                        <input 
                            ...
                            required
                            defaultValue={dataFromFilter ? dataFromFilter[index] : ''}
                        />
                        </>
                    )
